...
export class DailyTasksService {
  ...
  private serializeTimelineCheckinItem(
    ...
    return {
      ...
      studyTaskType: task?.studyTaskType ?? null,
      subject: task?.subject ?? null,
      materialRef: task?.materialRef ?? null,
      chapterRef: task?.chapterRef ?? null,
      questionCount: task?.questionCount ?? null,
      targetAccuracy: task?.targetAccuracy ?? null,
    ...
    return {
      ...
      sourceTask: sourceTask
        ? {
            ...
            studyTaskType: sourceTask.studyTaskType,
            subject: sourceTask.subject,
            materialRef: sourceTask.materialRef,
            chapterRef: sourceTask.chapterRef,
            questionCount: sourceTask.questionCount,
            targetAccuracy: sourceTask.targetAccuracy,
            evidenceRequired: sourceTask.evidenceRequired,
